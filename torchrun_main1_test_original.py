...
from galore_torch import GaLoreAdamW0, GaLoreAdamW8bit, GaLoreAdafactor,AdamWtest
wandb.login(key='0831d62c2353a87b23a963dcb28ecc86cef378ee')
...
def main(args):
    ...
    if args.optimizer.lower() == "adam":
        ...
        optimizer = AdamWtest(param_groups, lr=args.lr, weight_decay=args.weight_decay,gap=args.gap,name=name)
    # implement sgd
    ...
    for batch_idx, batch in enumerate(dataloader):
        ...
        print("Training loss at:",global_step,temp_loss/4.0)
        temp_loss=0
        if update_step%40==0:
            if global_rank==0:
